...
const getInitialState = (): GlobalState => {
  ...
  return {
    ...
    invitations: [
      ...
      { id: 'inv1', visitorName: 'Alex Rivera', visitorEmail: 'alex@techcorp.com', visitorCompany: 'TechCorp', hostId: 'usr_acme_1', hostName: 'Sarah Johnson', visitDate: '2024-11-28', visitTime: '10:00', purpose: 'Business Meeting', location: 'HQ - Building A', status: 'completed', visitorType: 'business', accessCode: 'AC1001', createdAt: '2024-11-27T09:00:00.000Z' },
      { id: 'inv2', visitorName: 'Jessica Wong', visitorEmail: 'jessica@innovate.com', visitorCompany: 'Innovate Solutions', hostId: 'usr_acme_2', hostName: 'David Martinez', visitDate: '2024-11-28', visitTime: '14:00', purpose: 'Sales Presentation', location: 'HQ - Building A', status: 'completed', visitorType: 'business', accessCode: 'AC1002', createdAt: '2024-11-27T10:00:00.000Z' },
      { id: 'inv3', visitorName: 'Michael Brown', visitorEmail: 'mbrown@consulting.com', visitorCompany: 'Brown Consulting', hostId: 'usr_acme_1', hostName: 'Sarah Johnson', visitDate: '2024-11-29', visitTime: '09:30', purpose: 'Consulting Session', location: 'HQ - Building B', status: 'approved', visitorType: 'business', accessCode: 'AC1003', createdAt: '2024-11-28T08:00:00.000Z' },
      { id: 'inv4', visitorName: 'Sophia Patel', visitorEmail: 'spatel@partners.com', visitorCompany: 'Partners Inc', hostId: 'usr_acme_3', hostName: 'Emily Chen', visitDate: '2024-11-29', visitTime: '11:00', purpose: 'Partnership Discussion', location: 'HQ - Building A', status: 'approved', visitorType: 'business', accessCode: 'AC1004', createdAt: '2024-11-28T09:00:00.000Z' },
      { id: 'inv5', visitorName: 'Daniel Kim', visitorEmail: 'dkim@startup.io', visitorCompany: 'Startup Labs', hostId: 'usr_acme_4', hostName: 'Robert Wilson', visitDate: '2024-11-30', visitTime: '15:00', purpose: 'Technical Review', location: 'HQ - Building C', status: 'pending', visitorType: 'business', accessCode: 'AC1005', createdAt: '2024-11-28T11:00:00.000Z' },
      { id: 'inv6', visitorName: 'Emma Taylor', visitorEmail: 'etaylor@design.com', visitorCompany: 'Design Co', hostId: 'usr_acme_2', hostName: 'David Martinez', visitDate: '2024-12-01', visitTime: '10:00', purpose: 'Design Review', location: 'HQ - Building A', status: 'pending', visitorType: 'business', accessCode: 'AC1006', createdAt: '2024-11-29T08:00:00.000Z' },
      { id: 'inv7', visitorName: 'Oliver Zhang', visitorEmail: 'ozhang@manufacturing.com', visitorCompany: 'Manufacturing Plus', hostId: 'usr_acme_1', hostName: 'Sarah Johnson', visitDate: '2024-12-02', visitTime: '13:00', purpose: 'Factory Tour', location: 'HQ - Building B', status: 'pending', visitorType: 'business', accessCode: 'AC1007', createdAt: '2024-11-29T09:00:00.000Z' },
      { id: 'inv8', visitorName: 'Isabella Lopez', visitorEmail: 'ilopez@finance.com', visitorCompany: 'Finance Corp', hostId: 'usr_acme_5', hostName: 'Lisa Anderson', visitDate: '2024-11-27', visitTime: '09:00', purpose: 'Financial Audit', location: 'HQ - Building A', status: 'pending', visitorType: 'business', accessCode: 'AC1008', createdAt: '2024-11-26T10:00:00.000Z' },
      { id: 'inv9', visitorName: 'Noah Johnson', visitorEmail: 'noah@logistics.com', visitorCompany: 'Logistics Plus', hostId: 'usr_acme_3', hostName: 'Emily Chen', visitDate: '2024-11-25', visitTime: '14:30', purpose: 'Supply Chain Meeting', location: 'HQ - Building C', status: 'completed', visitorType: 'business', accessCode: 'AC1009', createdAt: '2024-11-24T08:00:00.000Z' },
      { id: 'inv10', visitorName: 'Ava Martinez', visitorEmail: 'ava@research.org', visitorCompany: 'Research Institute', hostId: 'usr_acme_4', hostName: 'Robert Wilson', visitDate: '2024-11-26', visitTime: '11:00', purpose: 'Research Collaboration', location: 'HQ - Building A', status: 'completed', visitorType: 'business', accessCode: 'AC1010', createdAt: '2024-11-25T09:00:00.000Z' },
      { id: 'inv11', visitorName: 'Liam Chen', visitorEmail: 'lchen@security.com', visitorCompany: 'Security Systems', hostId: 'usr_acme_1', hostName: 'Sarah Johnson', visitDate: '2024-11-24', visitTime: '10:00', purpose: 'Security Assessment', location: 'HQ - Building B', status: 'completed', visitorType: 'business', accessCode: 'AC1011', createdAt: '2024-11-23T08:00:00.000Z' },
      { id: 'inv12', visitorName: 'Mia Wang', visitorEmail: 'mwang@legal.com', visitorCompany: 'Legal Partners', hostId: 'usr_acme_2', hostName: 'David Martinez', visitDate: '2024-11-23', visitTime: '16:00', purpose: 'Legal Consultation', location: 'HQ - Building A', status: 'completed', visitorType: 'business', accessCode: 'AC1012', createdAt: '2024-11-22T09:00:00.000Z' },
      { id: 'inv13', visitorName: 'Ethan White', visitorEmail: 'ewhite@marketing.com', visitorCompany: 'Marketing Agency', hostId: 'usr_acme_3', hostName: 'Emily Chen', visitDate: '2024-11-22', visitTime: '12:00', purpose: 'Marketing Campaign', location: 'HQ - Building C', status: 'completed', visitorType: 'business', accessCode: 'AC1013', createdAt: '2024-11-21T08:00:00.000Z' },
      { id: 'inv14', visitorName: 'Charlotte Davis', visitorEmail: 'cdavis@hr.com', visitorCompany: 'HR Solutions', hostId: 'usr_acme_1', hostName: 'Sarah Johnson', visitDate: '2024-11-21', visitTime: '09:30', purpose: 'Recruitment Drive', location: 'HQ - Building A', status: 'completed', visitorType: 'business', accessCode: 'AC1014', createdAt: '2024-11-20T08:00:00.000Z' },
      { id: 'inv15', visitorName: 'James Anderson', visitorEmail: 'janderson@training.com', visitorCompany: 'Training Corp', hostId: 'usr_acme_4', hostName: 'Robert Wilson', visitDate: '2024-11-20', visitTime: '14:00', purpose: 'Training Session', location: 'HQ - Building B', status: 'completed', visitorType: 'business', accessCode: 'AC1015', createdAt: '2024-11-19T08:00:00.000Z' },
      { id: 'inv16', visitorName: 'Amelia Brown', visitorEmail: 'abrown@insurance.com', visitorCompany: 'Insurance Co', hostId: 'usr_acme_5', hostName: 'Lisa Anderson', visitDate: '2024-11-19', visitTime: '10:30', purpose: 'Insurance Review', location: 'HQ - Building A', status: 'completed', visitorType: 'business', accessCode: 'AC1016', createdAt: '2024-11-18T08:00:00.000Z' },
      { id: 'inv17', visitorName: 'Benjamin Lee', visitorEmail: 'blee@realestate.com', visitorCompany: 'Real Estate Partners', hostId: 'usr_acme_2', hostName: 'David Martinez', visitDate: '2024-11-18', visitTime: '15:00', purpose: 'Property Discussion', location: 'HQ - Building C', status: 'completed', visitorType: 'business', accessCode: 'AC1017', createdAt: '2024-11-17T08:00:00.000Z' },
      { id: 'inv18', visitorName: 'Harper Wilson', visitorEmail: 'hwilson@architecture.com', visitorCompany: 'Architecture Firm', hostId: 'usr_acme_1', hostName: 'Sarah Johnson', visitDate: '2024-11-17', visitTime: '11:00', purpose: 'Building Plans', location: 'HQ - Building A', status: 'completed', visitorType: 'business', accessCode: 'AC1018', createdAt: '2024-11-16T08:00:00.000Z' },
      { id: 'inv19', visitorName: 'Lucas Garcia', visitorEmail: 'lgarcia@catering.com', visitorCompany: 'Catering Services', hostId: 'usr_acme_3', hostName: 'Emily Chen', visitDate: '2024-11-16', visitTime: '13:30', purpose: 'Event Catering', location: 'HQ - Building B', status: 'completed', visitorType: 'vip', accessCode: 'AC1019', createdAt: '2024-11-15T08:00:00.000Z' },
      { id: 'inv20', visitorName: 'Evelyn Martinez', visitorEmail: 'emartinez@cleaning.com', visitorCompany: 'Cleaning Corp', hostId: 'usr_acme_4', hostName: 'Robert Wilson', visitDate: '2024-11-15', visitTime: '08:00', purpose: 'Facility Inspection', location: 'HQ - Building A', status: 'completed', visitorType: 'business', accessCode: 'AC1020', createdAt: '2024-11-14T08:00:00.000Z' },
      // Additional invitations for better visualization - mostly business visitors
      { id: 'inv21', visitorName: 'William Foster', visitorEmail: 'wfoster@tech.com', visitorCompany: 'Tech Innovations', hostId: 'usr_acme_1', hostName: 'Sarah Johnson', visitDate: '2024-11-14', visitTime: '09:00', purpose: 'Product Demo', location: 'HQ - Building A', status: 'completed', visitorType: 'business', accessCode: 'AC1021', createdAt: '2024-11-13T08:00:00.000Z' },
      { id: 'inv22', visitorName: 'Olivia Turner', visitorEmail: 'oturner@media.com', visitorCompany: 'Media Corp', hostId: 'usr_acme_2', hostName: 'David Martinez', visitDate: '2024-11-13', visitTime: '14:00', purpose: 'Press Interview', location: 'HQ - Building B', status: 'completed', visitorType: 'business', accessCode: 'AC1022', createdAt: '2024-11-12T08:00:00.000Z' },
      { id: 'inv23', visitorName: 'Elijah Cooper', visitorEmail: 'ecooper@solutions.com', visitorCompany: 'Solutions Inc', hostId: 'usr_acme_3', hostName: 'Emily Chen', visitDate: '2024-11-12', visitTime: '10:30', purpose: 'Contract Negotiation', location: 'HQ - Building A', status: 'completed', visitorType: 'business', accessCode: 'AC1023', createdAt: '2024-11-11T08:00:00.000Z' },
      { id: 'inv24', visitorName: 'Sophia Mitchell', visitorEmail: 'smitchell@consulting.com', visitorCompany: 'Mitchell Consulting', hostId: 'usr_acme_4', hostName: 'Robert Wilson', visitDate: '2024-11-11', visitTime: '15:30', purpose: 'Strategy Session', location: 'HQ - Building C', status: 'completed', visitorType: 'business', accessCode: 'AC1024', createdAt: '2024-11-10T08:00:00.000Z' },
      { id: 'inv25', visitorName: 'Lucas Rodriguez', visitorEmail: 'lrodriguez@vendor.com', visitorCompany: 'Vendor Plus', hostId: 'usr_acme_1', hostName: 'Sarah Johnson', visitDate: '2024-11-10', visitTime: '11:00', purpose: 'Vendor Meeting', location: 'HQ - Building A', status: 'completed', visitorType: 'business', accessCode: 'AC1025', createdAt: '2024-11-09T08:00:00.000Z' },
      { id: 'inv26', visitorName: 'Mia Thompson', visitorEmail: 'mthompson@design.com', visitorCompany: 'Design Studio', hostId: 'usr_acme_2', hostName: 'David Martinez', visitDate: '2024-11-09', visitTime: '13:00', purpose: 'Design Consultation', location: 'HQ - Building B', status: 'completed', visitorType: 'business', accessCode: 'AC1026', createdAt: '2024-11-08T08:00:00.000Z' },
      { id: 'inv27', visitorName: 'Ethan Harris', visitorEmail: 'eharris@software.com', visitorCompany: 'Software Co', hostId: 'usr_acme_3', hostName: 'Emily Chen', visitDate: '2024-11-08', visitTime: '09:30', purpose: 'Software Demo', location: 'HQ - Building A', status: 'completed', visitorType: 'business', accessCode: 'AC1027', createdAt: '2024-11-07T08:00:00.000Z' },
      { id: 'inv28', visitorName: 'Ava Clark', visitorEmail: 'aclark@analytics.com', visitorCompany: 'Analytics Pro', hostId: 'usr_acme_4', hostName: 'Robert Wilson', visitDate: '2024-11-07', visitTime: '14:30', purpose: 'Data Analysis', location: 'HQ - Building C', status: 'completed', visitorType: 'business', accessCode: 'AC1028', createdAt: '2024-11-06T08:00:00.000Z' },
      { id: 'inv29', visitorName: 'Noah Lewis', visitorEmail: 'nlewis@startup.com', visitorCompany: 'Startup Hub', hostId: 'usr_acme_1', hostName: 'Sarah Johnson', visitDate: '2024-11-06', visitTime: '10:00', purpose: 'Pitch Presentation', location: 'HQ - Building A', status: 'completed', visitorType: 'business', accessCode: 'AC1029', createdAt: '2024-11-05T08:00:00.000Z' },
      { id: 'inv30', visitorName: 'Isabella Walker', visitorEmail: 'iwalker@finance.com', visitorCompany: 'Finance Group', hostId: 'usr_acme_2', hostName: 'David Martinez', visitDate: '2024-11-05', visitTime: '15:00', purpose: 'Financial Review', location: 'HQ - Building B', status: 'completed', visitorType: 'business', accessCode: 'AC1030', createdAt: '2024-11-04T08:00:00.000Z' },
      { id: 'inv31', visitorName: 'Mason King', visitorEmail: 'mking@logistics.com', visitorCompany: 'Logistics Co', hostId: 'usr_acme_3', hostName: 'Emily Chen', visitDate: '2024-11-04', visitTime: '11:30', purpose: 'Supply Chain', location: 'HQ - Building A', status: 'completed', visitorType: 'business', accessCode: 'AC1031', createdAt: '2024-11-03T08:00:00.000Z' },
      { id: 'inv32', visitorName: 'Charlotte Scott', visitorEmail: 'cscott@marketing.com', visitorCompany: 'Marketing Plus', hostId: 'usr_acme_4', hostName: 'Robert Wilson', visitDate: '2024-11-03', visitTime: '13:30', purpose: 'Marketing Strategy', location: 'HQ - Building C', status: 'completed', visitorType: 'business', accessCode: 'AC1032', createdAt: '2024-11-02T08:00:00.000Z' },
      { id: 'inv33', visitorName: 'Liam Young', visitorEmail: 'lyoung@engineering.com', visitorCompany: 'Engineering Firm', hostId: 'usr_acme_1', hostName: 'Sarah Johnson', visitDate: '2024-11-02', visitTime: '09:00', purpose: 'Technical Review', location: 'HQ - Building A', status: 'completed', visitorType: 'business', accessCode: 'AC1033', createdAt: '2024-11-01T08:00:00.000Z' },
      { id: 'inv34', visitorName: 'Emma Adams', visitorEmail: 'eadams@hr.com', visitorCompany: 'HR Consulting', hostId: 'usr_acme_2', hostName: 'David Martinez', visitDate: '2024-11-01', visitTime: '14:00', purpose: 'HR Consultation', location: 'HQ - Building B', status: 'completed', visitorType: 'business', accessCode: 'AC1034', createdAt: '2024-10-31T08:00:00.000Z' },
      { id: 'inv35', visitorName: 'Oliver Baker', visitorEmail: 'obaker@legal.com', visitorCompany: 'Legal Services', hostId: 'usr_acme_3', hostName: 'Emily Chen', visitDate: '2024-10-31', visitTime: '10:30', purpose: 'Legal Review', location: 'HQ - Building A', status: 'completed', visitorType: 'business', accessCode: 'AC1035', createdAt: '2024-10-30T08:00:00.000Z' },
      { id: 'inv36', visitorName: 'Sophia Nelson', visitorEmail: 'snelson@research.com', visitorCompany: 'Research Labs', hostId: 'usr_acme_4', hostName: 'Robert Wilson', visitDate: '2024-10-30', visitTime: '15:30', purpose: 'Research Collaboration', location: 'HQ - Building C', status: 'completed', visitorType: 'business', accessCode: 'AC1036', createdAt: '2024-10-29T08:00:00.000Z' },
      { id: 'inv37', visitorName: 'James Carter', visitorEmail: 'jcarter@insurance.com', visitorCompany: 'Insurance Partners', hostId: 'usr_acme_1', hostName: 'Sarah Johnson', visitDate: '2024-10-29', visitTime: '11:00', purpose: 'Policy Review', location: 'HQ - Building A', status: 'completed', visitorType: 'business', accessCode: 'AC1037', createdAt: '2024-10-28T08:00:00.000Z' },
      { id: 'inv38', visitorName: 'Mia Rivera', visitorEmail: 'mrivera@consulting.com', visitorCompany: 'Rivera Consulting', hostId: 'usr_acme_2', hostName: 'David Martinez', visitDate: '2024-10-28', visitTime: '13:00', purpose: 'Business Consulting', location: 'HQ - Building B', status: 'completed', visitorType: 'business', accessCode: 'AC1038', createdAt: '2024-10-27T08:00:00.000Z' },
      { id: 'inv39', visitorName: 'Ethan Roberts', visitorEmail: 'eroberts@security.com', visitorCompany: 'Security Solutions', hostId: 'usr_acme_3', hostName: 'Emily Chen', visitDate: '2024-10-27', visitTime: '09:30', purpose: 'Security Audit', location: 'HQ - Building A', status: 'completed', visitorType: 'business', accessCode: 'AC1039', createdAt: '2024-10-26T08:00:00.000Z' },
      { id: 'inv40', visitorName: 'Ava Phillips', visitorEmail: 'aphillips@training.com', visitorCompany: 'Training Academy', hostId: 'usr_acme_4', hostName: 'Robert Wilson', visitDate: '2024-10-26', visitTime: '14:30', purpose: 'Training Workshop', location: 'HQ - Building C', status: 'completed', visitorType: 'business', accessCode: 'AC1040', createdAt: '2024-10-25T08:00:00.000Z' },
      { id: 'inv41', visitorName: 'Noah Campbell', visitorEmail: 'ncampbell@tech.com', visitorCompany: 'Tech Ventures', hostId: 'usr_acme_1', hostName: 'Sarah Johnson', visitDate: '2024-10-25', visitTime: '10:00', purpose: 'Tech Discussion', location: 'HQ - Building A', status: 'completed', visitorType: 'business', accessCode: 'AC1041', createdAt: '2024-10-24T08:00:00.000Z' },
      { id: 'inv42', visitorName: 'Isabella Martinez', visitorEmail: 'imartinez@media.com', visitorCompany: 'Media Network', hostId: 'usr_acme_2', hostName: 'David Martinez', visitDate: '2024-10-24', visitTime: '15:00', purpose: 'Media Coverage', location: 'HQ - Building B', status: 'completed', visitorType: 'child', accessCode: 'AC1042', createdAt: '2024-10-23T08:00:00.000Z' },
      { id: 'inv43', visitorName: 'Mason Garcia', visitorEmail: 'mgarcia@realestate.com', visitorCompany: 'Real Estate Group', hostId: 'usr_acme_3', hostName: 'Emily Chen', visitDate: '2024-10-23', visitTime: '11:30', purpose: 'Property Discussion', location: 'HQ - Building A', status: 'completed', visitorType: 'business', accessCode: 'AC1043', createdAt: '2024-10-22T08:00:00.000Z' },
      { id: 'inv44', visitorName: 'Charlotte Lopez', visitorEmail: 'clopez@design.com', visitorCompany: 'Design Partners', hostId: 'usr_acme_4', hostName: 'Robert Wilson', visitDate: '2024-10-22', visitTime: '13:30', purpose: 'Design Presentation', location: 'HQ - Building C', status: 'completed', visitorType: 'business', accessCode: 'AC1044', createdAt: '2024-10-21T08:00:00.000Z' },
      { id: 'inv45', visitorName: 'Liam Gonzalez', visitorEmail: 'lgonzalez@startup.com', visitorCompany: 'Startup Capital', hostId: 'usr_acme_1', hostName: 'Sarah Johnson', visitDate: '2024-10-21', visitTime: '09:00', purpose: 'Investment Discussion', location: 'HQ - Building A', status: 'completed', visitorType: 'business', accessCode: 'AC1045', createdAt: '2024-10-20T08:00:00.000Z' },
      { id: 'inv46', visitorName: 'Emma Wilson', visitorEmail: 'ewilson@analytics.com', visitorCompany: 'Analytics Corp', hostId: 'usr_acme_2', hostName: 'David Martinez', visitDate: '2024-10-20', visitTime: '14:00', purpose: 'Data Presentation', location: 'HQ - Building B', status: 'completed', visitorType: 'business', accessCode: 'AC1046', createdAt: '2024-10-19T08:00:00.000Z' },
      { id: 'inv47', visitorName: 'Oliver Anderson', visitorEmail: 'oanderson@legal.com', visitorCompany: 'Anderson Legal', hostId: 'usr_acme_3', hostName: 'Emily Chen', visitDate: '2024-10-19', visitTime: '10:30', purpose: 'Contract Review', location: 'HQ - Building A', status: 'completed', visitorType: 'business', accessCode: 'AC1047', createdAt: '2024-10-18T08:00:00.000Z' },
      { id: 'inv48', visitorName: 'Sophia Thomas', visitorEmail: 'sthomas@consulting.com', visitorCompany: 'Thomas Consulting', hostId: 'usr_acme_4', hostName: 'Robert Wilson', visitDate: '2024-10-18', visitTime: '15:30', purpose: 'Strategic Planning', location: 'HQ - Building C', status: 'completed', visitorType: 'business', accessCode: 'AC1048', createdAt: '2024-10-17T08:00:00.000Z' },
      { id: 'inv49', visitorName: 'James Jackson', visitorEmail: 'jjackson@manufacturing.com', visitorCompany: 'Manufacturing Inc', hostId: 'usr_acme_1', hostName: 'Sarah Johnson', visitDate: '2024-10-17', visitTime: '11:00', purpose: 'Production Review', location: 'HQ - Building A', status: 'completed', visitorType: 'business', accessCode: 'AC1049', createdAt: '2024-10-16T08:00:00.000Z' },
      { id: 'inv50', visitorName: 'Mia White', visitorEmail: 'mwhite@healthcare.com', visitorCompany: 'Healthcare Solutions', hostId: 'usr_acme_2', hostName: 'David Martinez', visitDate: '2024-10-16', visitTime: '13:00', purpose: 'Healthcare Consultation', location: 'HQ - Building B', status: 'completed', visitorType: 'business', accessCode: 'AC1050', createdAt: '2024-10-15T08:00:00.000Z' },
    ],
    parkingSpaces: [
      // ACME tenant - Building A - Level 1 (20 spaces with mixed statuses)
      { id: 'p1', spaceNumber: 'A-101', building: 'Building A', location: 'Building A - Level 1', zone: 'Zone A', status: 'occupied', tenantId: 'acme', assignedTo: 'usr_acme_1', assignedToName: 'Sarah Johnson', vehiclePlate: 'ABC123' },
      { id: 'p2', spaceNumber: 'A-102', building: 'Building A', location: 'Building A - Level 1', zone: 'Zone A', status: 'occupied', tenantId: 'acme', assignedTo: 'usr_acme_2', assignedToName: 'David Martinez', vehiclePlate: 'XYZ789' },
      { id: 'p3', spaceNumber: 'A-103', building: 'Building A', location: 'Building A - Level 1', zone: 'Zone A', status: 'available', tenantId: 'acme' },
      { id: 'p4', spaceNumber: 'A-104', building: 'Building A', location: 'Building A - Level 1', zone: 'Zone B', status: 'occupied', tenantId: 'acme', assignedTo: 'usr_acme_3', assignedToName: 'Emily Chen', vehiclePlate: 'DEF456' },
      { id: 'p5', spaceNumber: 'A-105', building: 'Building A', location: 'Building A - Level 1', zone: 'Zone B', status: 'reserved', tenantId: 'acme', isReservedForVisitor: true },

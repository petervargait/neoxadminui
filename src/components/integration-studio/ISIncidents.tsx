...
const INITIAL_INCIDENTS: Incident[] = [
  {
    id: 'INC-0042',
    errorSignature: 'QuickBooks INTERNAL_SERVER_ERROR on getInvoice',
    severity: 'S1',
    ...
    notes: 'Ongoing since 10:30. QuickBooks API returning 500 intermittently. Escalated to platform team.',
    timeline: [
      ...
      { at: '2026-03-05 11:00:00', actor: 'jane.doe',     action: 'Note: Rolling back QuickBooks connector to v2.4.1' },
    ],
    linkedLogs: [
      { timestamp: '2026-03-05 14:50:00', operation: 'getInvoice',    httpStatus: 500, correlationId: 'cid-q7r8s9t0', error: 'Database connection timeout' },
      { timestamp: '2026-03-05 14:48:00', operation: 'createPayment', httpStatus: 500, correlationId: 'cid-ab12cd34', error: 'Database connection timeout' },
      { timestamp: '2026-03-05 14:46:00', operation: 'queryAccounts', httpStatus: 500, correlationId: 'cid-ef56gh78', error: 'Database connection timeout' },
    ],
  },
  {
    id: 'INC-0041',
    errorSignature: 'SAP ERP GATEWAY_TIMEOUT on delta token',
    severity: 'S1',
    connector: 'SAP ERP',
    count: 341,
    state: 'Acknowledged',
    ...
    notes: 'SAP backend not responding within 5s. Infrastructure team investigating network path.',
    timeline: [
      ...
      { at: '2026-03-05 02:00:00', actor: 'bob.smith', action: 'Note: Working with SAP BASIS team to increase gateway timeout' },
      { at: '2026-03-05 08:00:00', actor: 'bob.smith', action: 'Note: No resolution yet. Monitoring continues.' },
    ],
    linkedLogs: [
      { timestamp: '2026-03-05 14:35:00', operation: 'delta token',    httpStatus: 500, correlationId: 'cid-k7l8m9n0', error: 'Gateway timeout 5000ms exceeded' },
      { timestamp: '2026-03-05 13:35:00', operation: 'delta token',    httpStatus: 500, correlationId: 'cid-op90qr12', error: 'Gateway timeout 5000ms exceeded' },
    ],
  },
  {
    id: 'INC-0040',
    errorSignature: 'SendGrid RATE_LIMIT_EXCEEDED on sendEmail',
    severity: 'S2',
    connector: 'SendGrid',
    count: 63,
    state: 'Acknowledged',
    ...
    notes: 'Rate limit hit during bulk campaign send. Backoff strategy applied but consumers are queuing up.',
    timeline: [
      ...
      { at: '2026-03-05 14:45:00', actor: 'carol.white',  action: 'Note: Contacted SendGrid support to raise rate limits' },
    ],
    linkedLogs: [
      { timestamp: '2026-03-05 14:40:20', operation: 'getStats',  httpStatus: 503, correlationId: 'cid-g3h4i5j6', error: 'Service unavailable – upstream timeout' },
      { timestamp: '2026-03-05 14:36:00', operation: 'sendEmail', httpStatus: 429, correlationId: 'cid-u1v2w3x4', error: 'Rate limit exceeded, retry after 60s' },
    ],
  },
  {
    id: 'INC-0039',
    errorSignature: 'Salesforce high latency on queryLeads (>700ms)',
    severity: 'S3',
    ...
    notes: 'P95 latency elevated. Possibly related to Salesforce governor limits on shared instance.',
    timeline: [
    ...
    linkedLogs: [
      { timestamp: '2026-03-05 14:52:44', operation: 'queryLeads',         httpStatus: 200, correlationId: 'cid-m3n4o5p6', error: 'High latency: 721ms' },
      { timestamp: '2026-03-05 13:10:00', operation: 'createOpportunity',  httpStatus: 200, correlationId: 'cid-st34uv56', error: 'High latency: 845ms' },
    ],
  },
  {
    id: 'INC-0038',
    errorSignature: 'GitHub createIssue auth failure (403)',
    severity: 'S2',
    connector: 'GitHub',
    count: 12,
    state: 'Resolved',
    ...
    notes: 'GitHub token expired. Rotated credentials via Vault. Issue resolved.',
    timeline: [
      ...
      { at: '2026-03-04 16:30:00', actor: 'emily.chen',  action: 'Note: Identified expired GitHub PAT in Vault secret' },
      { at: '2026-03-04 16:45:00', actor: 'emily.chen',  action: 'Rotated GitHub token via Vault. Connector recovered.' },
      { at: '2026-03-04 16:46:00', actor: 'emily.chen',  action: 'Resolved the incident' },
    ],
    linkedLogs: [
      { timestamp: '2026-03-04 16:00:00', operation: 'createIssue', httpStatus: 403, correlationId: 'cid-wx78yz90', error: 'Bad credentials – token expired' },
    ],
  },
  {
    id: 'INC-0037',
    errorSignature: 'HubSpot getContacts 422 validation error',
    severity: 'S4',
    connector: 'HubSpot',
    count: 5,
    state: 'Resolved',
    ...
    notes: 'Malformed filter expression sent by upstream integration. Fixed query builder.',
    timeline: [
      ...
      { at: '2026-03-04 09:40:00', actor: 'frank.miller',  action: 'Deployed fix for query builder. Incident resolved.' },
      { at: '2026-03-04 09:41:00', actor: 'frank.miller',  action: 'Resolved the incident' },
    ],
    linkedLogs: [
      { timestamp: '2026-03-04 09:00:00', operation: 'getContacts', httpStatus: 422, correlationId: 'cid-ab12ef34', error: 'Invalid filter expression: unexpected token' },
    ],
  },
]

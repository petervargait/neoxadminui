...
const CANONICAL_DOMAINS: CanonicalDomain[] = [
  {
    ...
    name: 'Identity',
    icon: '👤',
    description: 'User identity lifecycle: provisioning, deprovisioning, and attribute synchronization.',
    color: IS.blue,
    operations: [
      {
        id: 'identity.getUser',
        ...
        description: 'Retrieve full identity record for a user including attributes and status.',
        responseSchema: [
          ...
          { name: 'attributes', type: 'object', children: [
      ...
      {
        id: 'identity.provisionUser',
        method: 'POST',
        path: '/identity/users',
        description: 'Provision a new user identity into the platform.',
        requestSchema: [
          { name: 'email', type: 'string', required: true },
          { name: 'displayName', type: 'string', required: true },
      ...
      {
        id: 'identity.updateUser',
        method: 'PUT',
        path: '/identity/users/{userId}',
        description: 'Update an existing identity record attributes.',
        requestSchema: [
      ...
      {
        id: 'identity.deprovisionUser',
        method: 'DELETE',
        path: '/identity/users/{userId}',
        description: 'Deprovision a user, revoking access across all connected systems.',
      },
    ],
  },
  {
    ...
    name: 'Access Control',
    icon: '🔐',
    description: 'Physical and logical access rules, door events, and credential management.',
    color: IS.purple,
    operations: [
      {
  ...
  },
  {
    ...
    icon: '📅',
    description: 'Room and desk booking, calendar sync, occupancy, and equipment management.',
    color: IS.green,
    operations: [
      {
  ...
  },
  {
    ...
    icon: '🎫',
    description: 'Facility issue tickets, SLA tracking, and ITSM bidirectional sync.',
    color: IS.red,
    operations: [
      {
        id: 'issues.createTicket',
        method: 'POST',
        path: '/issues/tickets',
      ...
      {
        id: 'issues.updateTicket',
        method: 'PUT',
        path: '/issues/tickets/{ticketId}',

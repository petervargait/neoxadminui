...
const INITIAL_WEBHOOKS: WebhookSubscription[] = [
  {
    id: 'wh-001',
    connector: 'Stripe',
    callbackUrl: 'https://api.neox.io/hooks/stripe',
    signatureSecretRef: 'secret/stripe-webhook-sig',
    eventTypes: ['payment.succeeded', 'payment.failed', 'refund.created'],
    status: 'ok',
  },
  {
    id: 'wh-002',
    connector: 'Salesforce',
    callbackUrl: 'https://api.neox.io/hooks/sf',
    signatureSecretRef: 'secret/sf-webhook-sig',
    eventTypes: ['Opportunity.Updated', 'Lead.Created'],
    status: 'warning',
  },
  {
    id: 'wh-003',
    connector: 'GitHub',
    callbackUrl: 'https://api.neox.io/hooks/github',
    signatureSecretRef: 'secret/github-webhook-sig',
  ...
  },
  {
    id: 'wh-004',
    connector: 'Twilio',
    callbackUrl: 'https://api.neox.io/hooks/twilio',
    signatureSecretRef: 'secret/twilio-webhook-sig',
    eventTypes: ['message.received', 'call.completed'],
    status: 'inactive',
  },
  {
    id: 'wh-005',
    connector: 'SendGrid',
    callbackUrl: 'https://api.neox.io/hooks/sendgrid',
    signatureSecretRef: 'secret/sendgrid-webhook-sig',
...
const INITIAL_POLLING_JOBS: PollingJob[] = [
  ...
  },
  {
    ...
    connector: 'HubSpot',
    schedule: '0 * * * *',
    cursorStrategy: 'updatedAt offset',
    batchSize: 100,
  ...
  },
  {
    ...
    batchSize: 1000,
    lastRun: '2026-03-05 01:00:00',
    status: 'critical',
  },
]

const REPLAY_RESULTS_SAMPLE: ReplayResult[] = [
  { eventId: 'evt_1KqM2x8R', connector: 'Stripe', eventType: 'payment.succeeded', replayedAt: '2026-03-05 14:57:22', outcome: 'success' },
  { eventId: 'evt_1KqM3y9T', connector: 'Stripe', eventType: 'refund.created',     replayedAt: '2026-03-05 14:57:23', outcome: 'success' },
  { eventId: 'evt_1KqNaz01', connector: 'Stripe', eventType: 'payment.failed',      replayedAt: '2026-03-05 14:57:23', outcome: 'failed'  },
  { eventId: 'evt_1KqObB12', connector: 'Stripe', eventType: 'payment.succeeded', replayedAt: '2026-03-05 14:57:24', outcome: 'skipped' },
]
